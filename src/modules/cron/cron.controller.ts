...
export class CronController {
  ...
  @Post('mark-absent')
  @ApiOperation({ summary: 'Mark absent employees for all active companies (daily)' })
  async markAbsent() {
  ...
  @ApiOperation({ summary: 'Generate payroll for all active companies with open periods (monthly)' })
  ...
  @Post('keep-alive')
  @ApiOperation({ summary: 'Keep-alive ping to prevent service spin-down (every 10 min)' })
  async keepAlive() {
