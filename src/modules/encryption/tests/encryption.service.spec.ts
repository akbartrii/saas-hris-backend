...
describe('EncryptionService', () => {
  ...
  describe('isEncrypted', () => {
    it('should return true for encrypted value', () => {
      expect(service.isEncrypted('7b6a5c4d3e2f1a0b:abc123def4567890abcdef:abc123def456')).toBe(true);
    });
  ...
  describe('validateKeycode', () => {
    it('should return true for valid keycode', async () => {
      mockPrisma.ms_salary_keys.findFirst.mockResolvedValue({ id: 'sk1', keycode_hash: '$2a$10$hashvalue' });
