...
describe("OvertimeMealAllowanceService", () => {
  ...
  beforeEach(async () => {
    ...
    service = module.get<OvertimeMealAllowanceService>(
      OvertimeMealAllowanceService,
    );
  ...
  describe("list", () => {
    it("should return all meal allowances for a company", async () => {
      mockPrisma.ms_overtime_meal_allowances.findMany.mockResolvedValue([
        { id: "ma1", day_type: "weekday", amount: 25000 },
      ]);
  ...
  describe("create", () => {
    it("should create a meal allowance for admin", async () => {
      ...
      mockPrisma.ms_overtime_meal_allowances.create.mockResolvedValue({
        id: "ma1",
        ...dto,
      });
