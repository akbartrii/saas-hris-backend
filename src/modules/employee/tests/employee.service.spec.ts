...
describe("EmployeeService", () => {
  ...
  describe("listEmployees", () => {
    it("should return paginated employees", async () => {
      ...
      const result = await service.listEmployees("u1", "c1", "admin", {
        page: 1,
        limit: 10,
      } as any);
  ...
  describe("createEmployee", () => {
    ...
    it("should create employee successfully", async () => {
      ...
      mockPrisma.ms_roles.findFirst.mockResolvedValue({
        id: "r1",
        name: "karyawan",
      });
      mockPrisma.ms_users.create.mockResolvedValue({
        id: "u2",
        email: dto.email,
      });
      mockPrisma.ms_employees.create.mockResolvedValue({
        id: "e1",
  ...
  describe("getEmployeeDetail", () => {
    it("should throw NotFoundException when employee not found", async () => {
      ...
      await expect(service.getEmployeeDetail("u1", "c1", "e1")).rejects.toThrow(
        NotFoundException,
      );
    });
