...
describe('ParameterService', () => {
  ...
  describe('findAll', () => {
    it('should return all parameters', async () => {
      mockPrisma.ms_parameters.findMany.mockResolvedValue([{ id: 1, key: 'overtime_rate', value: '1.5' }]);
  ...
  describe('getValue', () => {
    it('should return value', async () => {
      mockPrisma.ms_parameters.findUnique.mockResolvedValue({ id: 1, key: 'overtime_rate', value: '1.5' });
  ...
  describe('create', () => {
    it('should create a parameter', async () => {
      mockPrisma.ms_parameters.create.mockResolvedValue({ id: 1, key: 'overtime_rate', value: '1.5' });
