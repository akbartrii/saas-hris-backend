...
describe("OvertimeService", () => {
  ...
  const mockEncryptionService = {
    decrypt: jest.fn().mockReturnValue("5000000"),
    validateKeycode: jest.fn().mockResolvedValue(true),
  };
  ...
  describe("createOvertime", () => {
    it("should create an overtime request", async () => {
      ...
      mockPrisma.tr_overtime_requests.create.mockResolvedValue({
        id: "ot1",
        total_overtime_pay: 100000,
      });
      ...
      const result = await service.createOvertime(
        "u1",
        "c1",
        dto as any,
        "admin",
  ...
  describe("cancelOvertime", () => {
    it("should cancel a pending request", async () => {
      mockPrisma.tr_overtime_requests.findUnique.mockResolvedValue({
        id: "ot1",
        company_id: "c1",
        employee_id: "e1",
        status: "pending",
      ...
      mockPrisma.tr_overtime_requests.update.mockResolvedValue({
        id: "ot1",
        status: "cancelled",
      });
