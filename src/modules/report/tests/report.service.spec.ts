...
describe("ReportService", () => {
  ...
  describe("attendanceReport", () => {
    ...
    it("should throw ForbiddenException for non-admin", async () => {
      await expect(
        service.attendanceReport("c1", "karyawan", {} as any),
  ...
  describe("overtimeReport", () => {
    it("should return overtime data for admin", async () => {
      mockPrisma.tr_overtime_requests.findMany.mockResolvedValue([
        { id: "ot1", total_overtime_pay: 100000 },
      ]);
